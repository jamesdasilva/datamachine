...
var AttributeGenerator = /** @class */ (function () {
    function AttributeGenerator(typesRegistry) {
...
var types_registry_1 = __importDefault(__webpack_require__(/*! ../../../../driven-adapters/types/types-registry */ "./src/driven-adapters/types/types-registry.ts"));
    ...
    ObjectGenerator.prototype.generate = function (objeto) {
        ...
        Object.keys(objeto).forEach(function (item) {
            if (typeof objeto[item] == 'object' && objeto[item].constructor != RegExp) {
                ...
                result[item] = new attribute_generator_1.default(new types_registry_1.default()).generate(objeto[item]);
            }
        });
        return result;
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = (function (obj1, obj2, childName) {
    if (childName) {
        var objWithChild = {};
...
var Decimal = /** @class */ (function () {
    function Decimal() {
        this.regExp = /^decimal:\d+;\d*\.?\d+;\d*\.?\d+$/;
    }
    Decimal.prototype.generate = function (params) {
    ...
    Decimal.prototype.test = function (stringType) {
...
/***/ "./src/driven-adapters/types/randRegExp.ts":
/*!*************************************************!*\
  !*** ./src/driven-adapters/types/randRegExp.ts ***!
  \*************************************************/
/*! no static exports found */
...
var RandRegExp = /** @class */ (function () {
    function RandRegExp() {
    }
    RandRegExp.prototype.generate = function (params) {
        return new RandExp(new RegExp(params[0].slice(1, params[0].length - 1))).gen();
    };
    return RandRegExp;
}());
exports.default = RandRegExp;


/***/ }),

/***/ "./src/driven-adapters/types/types-registry.ts":
/*!*****************************************************!*\
  !*** ./src/driven-adapters/types/types-registry.ts ***!
  \*****************************************************/
/*! no static exports found */
...
var decimal_1 = __importDefault(__webpack_require__(/*! ./decimal */ "./src/driven-adapters/types/decimal.ts"));
var randRegExp_1 = __importDefault(__webpack_require__(/*! ./randRegExp */ "./src/driven-adapters/types/randRegExp.ts"));
// const email = require('./email');
// const __enum = require('./enum');
// const firstName = require('./firstName');
// const id = require('./id');
// const idAutoIncrement = require('./idAutoIncrement');
var TypesRegistry = /** @class */ (function () {
    function TypesRegistry() {
        this.types = {};
        // this.types['boolean'] = boolean;
        // this.types['cpf'] = cpf;
        // this.types['date'] = date;
        this.types['decimal'] = new decimal_1.default();
        this.types['regexp'] = new randRegExp_1.default();
    ...
    TypesRegistry.prototype.get = function (tName) {
        return this.types[tName];
    };
    return TypesRegistry;
}());
exports.default = TypesRegistry;
...
/***/ "./src/helpers/generateRandomNumber.ts":
/*!*********************************************!*\
  !*** ./src/helpers/generateRandomNumber.ts ***!
  \*********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
function default_1(inferiorLimit, upperLimit) {
...
function default_1(moldFileName) {
    ...
    var barType = barra[0];
    if (barType == '\\') {
        var moldFileNameWithBackslash = moldFileName.replace(/\//, '\\');
        return cwd + "\\" + moldFileNameWithBackslash;
    }
    else {
        var moldFileNameWithBar = moldFileName.replace(/\\/, '//');
...
Object.defineProperty(exports, "__esModule", { value: true });
var generateRandomNumber_1 = __importDefault(__webpack_require__(/*! ./generateRandomNumber */ "./src/helpers/generateRandomNumber.ts"));
